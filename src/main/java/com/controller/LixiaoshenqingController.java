...
public class LixiaoshenqingController {
    ...
    public R page(@RequestParam Map<String, Object> params,LixiaoshenqingEntity lixiaoshenqing, 
                @RequestParam(required = false) @DateTimeFormat(pattern="yyyy-MM-dd HH:mm:ss") Date lixiaoshijianstart,
                @RequestParam(required = false) @DateTimeFormat(pattern="yyyy-MM-dd HH:mm:ss") Date lixiaoshijianend,
        ...
        EntityWrapper<LixiaoshenqingEntity> ew = new EntityWrapper<LixiaoshenqingEntity>();
                if(lixiaoshijianstart!=null) ew.ge("lixiaoshijian", lixiaoshijianstart);
                if(lixiaoshijianend!=null) ew.le("lixiaoshijian", lixiaoshijianend);
