<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.yuekangma" label="粤康码" prop="yuekangma">
          <file-upload
          tip="点击上传粤康码"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.yuekangma?ruleForm.yuekangma:''"
          @change="yuekangmaUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.yuekangma" label="粤康码" prop="yuekangma">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.yuekangma.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.hesuanma" label="核酸码" prop="hesuanma">
          <file-upload
          tip="点击上传核酸码"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.hesuanma?ruleForm.hesuanma:''"
          @change="hesuanmaUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.hesuanma" label="核酸码" prop="hesuanma">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.hesuanma.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tiwen = true;
          ...
          if(o=='yuekangma'){
            this.ruleForm.yuekangma = obj[o];
	    this.ro.yuekangma = true;
            continue;
          }
          if(o=='xingchengma'){
	    ...
	    this.ro.xingchengma = true;
          ...
          if(o=='hesuanma'){
            this.ruleForm.hesuanma = obj[o];
	    this.ro.hesuanma = true;
            continue;
          }
        }
      }
	...
	if(this.ruleForm.yuekangma!=null) {
		this.ruleForm.yuekangma = this.ruleForm.yuekangma.replace(new RegExp(this.$base.url,"g"),"");
	}
	...
	if(this.ruleForm.hesuanma!=null) {
		this.ruleForm.hesuanma = this.ruleForm.hesuanma.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
    ...
    yuekangmaUploadChange(fileUrls) {
	this.ruleForm.yuekangma = fileUrls;
	this.addEditUploadStyleChange()
    },
    ...
    hesuanmaUploadChange(fileUrls) {
	this.ruleForm.hesuanma = fileUrls;
	this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
