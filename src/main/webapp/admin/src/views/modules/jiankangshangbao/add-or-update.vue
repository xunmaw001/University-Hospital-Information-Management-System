      ...
      <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.hesuanbaogao" label="核酸报告" prop="hesuanbaogao">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.hesuanbaogao.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  created() {
	this.ruleForm.shangbaoshijian = this.getCurDate()
