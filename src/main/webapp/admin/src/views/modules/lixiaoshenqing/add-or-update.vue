<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="离校时间" prop="lixiaoshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.lixiaoshijian" 
                type="datetime"
                :readonly="ro.lixiaoshijian"
                placeholder="离校时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.lixiaoshijian" label="离校时间" prop="lixiaoshijian">
              <el-input v-model="ruleForm.lixiaoshijian" 
                placeholder="离校时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiaose = true;
          ...
          if(o=='lixiaoshijian'){
            this.ruleForm.lixiaoshijian = obj[o];
	    this.ro.lixiaoshijian = true;
            continue;
          }
          if(o=='mudedi'){
