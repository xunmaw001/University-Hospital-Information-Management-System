<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="请假编号" prop="qingjiabianhao">
            <el-input v-model="ruleForm.qingjiabianhao" 
                placeholder="请假编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.qingjiabianhao" label="请假编号" prop="qingjiabianhao">
              <el-input v-model="ruleForm.qingjiabianhao" 
                placeholder="请假编号" readonly></el-input>
          </el-form-item>
        </div>
