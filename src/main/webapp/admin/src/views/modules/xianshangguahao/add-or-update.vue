<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="挂号编号" prop="guahaobianhao">
            <el-input v-model="ruleForm.guahaobianhao" 
                placeholder="挂号编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.guahaobianhao" label="挂号编号" prop="guahaobianhao">
              <el-input v-model="ruleForm.guahaobianhao" 
                placeholder="挂号编号" readonly></el-input>
          </el-form-item>
        </div>
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `xianshangguahao/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.xianshangguahaoCrossAddOrUpdateFlag = false;
						 this.parent.search();
