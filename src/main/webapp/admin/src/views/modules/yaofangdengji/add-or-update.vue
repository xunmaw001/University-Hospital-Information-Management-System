<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="病历编号" prop="binglibianhao">
          <el-input v-model="ruleForm.binglibianhao" 
              placeholder="病历编号" clearable  :readonly="ro.binglibianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="病历编号" prop="binglibianhao">
              <el-input v-model="ruleForm.binglibianhao" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="疾病类型" prop="jibingleixing">
          <el-input v-model="ruleForm.jibingleixing" 
              placeholder="疾病类型" clearable  :readonly="ro.jibingleixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="疾病类型" prop="jibingleixing">
              <el-input v-model="ruleForm.jibingleixing" 
                placeholder="疾病类型" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="药方" prop="yaofang">
          <el-input v-model="ruleForm.yaofang" 
              placeholder="药方" clearable  :readonly="ro.yaofang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="药方" prop="yaofang">
              <el-input v-model="ruleForm.yaofang" 
                placeholder="药方" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="用法" prop="yongfa">
          <el-input v-model="ruleForm.yongfa" 
              placeholder="用法" clearable  :readonly="ro.yongfa"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="用法" prop="yongfa">
              <el-input v-model="ruleForm.yongfa" 
                placeholder="用法" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.kaiyaoshijian = this.getCurDateTime()
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `yaofangdengji/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.yaofangdengjiCrossAddOrUpdateFlag = false;
						 this.parent.search();
