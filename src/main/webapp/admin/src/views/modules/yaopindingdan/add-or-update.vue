<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="药品数量" prop="yaopinshuliang">
          <el-input v-model="ruleForm.yaopinshuliang" 
              placeholder="药品数量" clearable  :readonly="ro.yaopinshuliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="药品数量" prop="yaopinshuliang">
              <el-input v-model="ruleForm.yaopinshuliang" 
                placeholder="药品数量" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="药品售价" prop="yaopinshoujia">
          <el-input v-model="ruleForm.yaopinshoujia" 
              placeholder="药品售价" clearable  :readonly="ro.yaopinshoujia"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="药品售价" prop="yaopinshoujia">
              <el-input v-model="ruleForm.yaopinshoujia" 
                placeholder="药品售价" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  computed: {
    ...
    zongjine:{
      get: function () {
        return 1*this.ruleForm.yaopinshuliang*this.ruleForm.yaopinshoujia
      }
    },
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yaopinshuliang = true;
          ...
          if(o=='yaopinshoujia'){
            this.ruleForm.yaopinshoujia = obj[o];
	    this.ro.yaopinshoujia = true;
            continue;
          }
          if(o=='zongjine'){
        ...
        this.ruleForm.yaopinshuliang = 0
	    this.ro.yaopinshuliang = false;
      }
      // 获取用户信息
      this.$http({
...
var objcross = this.$storage.getObj('crossObj');
      ...
      if(objcross!=null) {
	      objcross.yaopinshuliang = objcross.yaopinshuliang - this.ruleForm.yaopinshuliang
	      if(objcross.yaopinshuliang<0){
		this.$message.error("药品数量不足");
		return
	      }
                }
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `yaopindingdan/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.yaopindingdanCrossAddOrUpdateFlag = false;
						 this.parent.search();
