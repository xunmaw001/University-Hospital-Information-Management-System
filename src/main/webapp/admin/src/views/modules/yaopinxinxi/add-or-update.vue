<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="药品正式名" prop="yaopinzhengshiming">
          <el-input v-model="ruleForm.yaopinzhengshiming" 
              placeholder="药品正式名" clearable  :readonly="ro.yaopinzhengshiming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="药品正式名" prop="yaopinzhengshiming">
              <el-input v-model="ruleForm.yaopinzhengshiming" 
                placeholder="药品正式名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yaopinmingcheng = true;
          ...
          if(o=='yaopinzhengshiming'){
            this.ruleForm.yaopinzhengshiming = obj[o];
	    this.ro.yaopinzhengshiming = true;
            continue;
          }
          if(o=='tupian'){
