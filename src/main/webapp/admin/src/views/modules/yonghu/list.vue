  ...
  <div class="main-content">
    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
		...
		<el-form-item class="select" label="角色" prop="jiaose">
		  <el-select  @change="jiaoseChange" clearable v-model="searchForm.jiaose" placeholder="请选择角色">
		    <el-option
...
export default {
  ...
  methods: {
    ...
    init () {
          this.jiaoseOptions = "学生,教职工".split(',')
          this.$http({
