<template>
  <div>
      ...
      <div class="login-form">
        <h1 class="h1">基于ssm的大学校医院信息管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			<!-- <div v-if="tableName=='xiaoyi'" class="input-group">
			   <div class="label">校医工号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.xiaoyigonghao" class="input" type="text" placeholder="校医工号">
			   </div>
			 </div> -->
			<el-form-item label="校医工号" class="input" v-if="tableName=='xiaoyi'">
			  <el-input v-model="ruleForm.xiaoyigonghao" autocomplete="off" placeholder="校医工号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='xiaoyi'" class="input-group">
			   <div class="label">校医姓名</div>
			   <div class="input-container">
			     <input v-model="ruleForm.xiaoyixingming" class="input" type="text" placeholder="校医姓名">
			   </div>
			 </div> -->
			<el-form-item label="校医姓名" class="input" v-if="tableName=='xiaoyi'">
			  <el-input v-model="ruleForm.xiaoyixingming" autocomplete="off" placeholder="校医姓名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='xiaoyi'" class="input-group">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='xiaoyi'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<el-form-item label="确认密码" class="input" v-if="tableName=='xiaoyi'">
			...
			<el-form-item label="职称" class="input" v-if="tableName=='xiaoyi'">
			...
			<el-form-item label="医龄" class="input" v-if="tableName=='xiaoyi'">
			...
			<el-form-item label="联系电话" class="input" v-if="tableName=='xiaoyi'">
			  <el-input v-model="ruleForm.lianxidianhua" autocomplete="off" placeholder="联系电话"  />
			</el-form-item>
			<!-- <div v-if="tableName=='xiaoyi'" class="input-group">
			   <div class="label">坐诊时间</div>
			   <div class="input-container">
			     <input v-model="ruleForm.zuozhenshijian" class="input" type="text" placeholder="坐诊时间">
			   </div>
			 </div> -->
			<el-form-item label="坐诊时间" class="input" v-if="tableName=='xiaoyi'">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      if((!this.ruleForm.xiaoyigonghao) && `xiaoyi` == this.tableName){
        this.$message.error(`校医工号不能为空`);
        return
      }
      if((!this.ruleForm.xiaoyixingming) && `xiaoyi` == this.tableName){
        this.$message.error(`校医姓名不能为空`);
        return
      }
      if((this.ruleForm.mima!=this.ruleForm.mima2) && `xiaoyi` == this.tableName){
	    this.$message.error(`两次密码输入不一致`);
	    return
      }
      if(`xiaoyi` == this.tableName && this.ruleForm.lianxidianhua&&(!this.$validate.isMobile(this.ruleForm.lianxidianhua))){
